...
"""
    ...
    if params:
        ...
        for param_name, param_value in params.items():
            if param_name == "writeback_stage" and param_value:
                script += f"chparam -set WritebackStage 1 {top_module}\n"
            elif isinstance(param_value, bool):
                script += f"chparam -set {param_name} {1 if param_value else 0} {top_module}\n"
            elif isinstance(param_value, int):
                script += f"chparam -set {param_name} {param_value} {top_module}\n"
